...
This continues an example developed in library `qtl2ggplot` using data
...
Calculate allele probabilities from genotype probabilities.
...
snppr <- qtl2::genoprob_to_snpprob(apr, snpinfo)
```
...
** There seems to be some problem with scan_pattern with multiple traits.
