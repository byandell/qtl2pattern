...
```{r}
ggplot2::autoplot(scan_snppr, snpinfo, patterns="all",drop.hilit=1.5,cex=2)
```

## Strain Distribution Pattern (SDP) Scan

**These summaries have too many digits.**

SStrain distribution patterns (SDPs) separate out SNPs based on their SDP and plot the top patterns.
...
```{r}
tmpfile <- tempfile()
download.file(file.path("https://raw.githubusercontent.com/rqtl/qtl2data/master/DOex",
                        "c2_genes.rds"), tmpfile, quiet=TRUE)
