...
```{r}
autoplot(coefs2, DOex$pmap)
```

```{r}
autoplot(coefs2, DOex$pmap, columns=4:5)
```

```{r}
autoplot(coefs2, DOex$pmap, facet="geno")
```

```{r}
autoplot(coefs2, DOex$pmap, 4:5, facet="geno")
```
