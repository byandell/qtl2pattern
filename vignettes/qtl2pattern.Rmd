...
Plot of genes with SNPs above a threshold.

```{r}
class(gene_tbl) <- c("feature_tbl", class(gene_tbl))
autoplot(gene_tbl, top_snps_tbl = top_snps_tbl)
```


```{r}
ggplot2::autoplot(scan_snppr, snpinfo, patterns="hilit",drop.hilit=1.5,cex=2, show_all_snps = FALSE)
```
